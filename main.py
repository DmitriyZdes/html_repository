...
<main>
        ...
        <main class="row">
            <div class="row text-center">
                <div class="col-4">
                    <div class="card mb-4 rounded-3 shadow-sm">
                        <div class="card-header py-3">
                            <h4 class="my-0 fw-normal">Контактная информация</h4>
                        </div>
                        <div class="card-body">
                            <p>
                              <form>
  ...
  <a class="btn btn-success">Как купить?</a>
  <button class="btn btn-success">Как доставить?</button>
  <button class="btn btn-success">Какая гарантия?</button>
                        </p>
